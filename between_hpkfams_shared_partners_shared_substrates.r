...
##  'between_hpkfams_shared_partners_shared_substrates.pl'
## This script will generate a lattice scatter plot of shared substrates vs
## shared partners for each pair of kinase families.
##
##
...
inputfile="between_hpkfams_shared_partners_shared_substrates_ppiscompl.tab"
...
png(output_png, width=40, height=40, units = 'cm', res=300, pointsize=6)
xyplot(sharedsubstrates ~ sharedpartners|hpkfamilypair, col="red",
  main="Number of shared substrates vs. number of shared partners\nfor kinase family pairs",
  xlab="Number of shared partners",
  ylab="Number of shared substrates",
  ## Setting font size and color of boxes headers
  par.strip.text = list(cex = 0.5,col="black"),
  ## Setting the scales
  scales=list(log=10),
